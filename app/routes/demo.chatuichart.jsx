        ...
        <div className="flex h-screen w-full flex-col items-center bg-white">
          <div className="w-full shadow-lg">
            <div className="flex justify-between items-center h-16 ">
              ...
              {/* <div className="flex justify-end left-0 items-center bg-white">
                <button
                  type="button"
              ...
              <div className="flex justify-end items-center mr-4">
                <button
                  ...
                  onClick={toggleSidebar}
                >
                  <ChevronLeftIcon className=" flex items-center h-6 w-6" aria-hidden="true" />
                </button>
              </div>
            </div>
          </div>
          <div className="max-w-7xl w-4/6 mx-auto  flex-grow overflow-y-auto">
